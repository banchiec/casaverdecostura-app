    ...
    <Container>
      <Row className="container-about">
        <Row className='container-title'>
          <h3 className='contacts-title'>Contacta con CASAVERDECOSTURA</h3>
          <h5 className='contacts-subtitle'>¿Tienes alguna duda? ¡Contáctanos! Para visitar nuestra tienda, consultar sobre algún producto o concertar una cita</h5>
        </Row>
        <Row>
          <Col xs={12} className='container-card'>
            <Row>
              <Col>

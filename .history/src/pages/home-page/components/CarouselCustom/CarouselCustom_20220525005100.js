							...
							<div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
								...
								<div className="carousel-inner">
										<div className="carousel-item active">
											<div className="row">
													<div style="background-image:url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/46992/flexfun04.jpg');" className="col-12 col-md d-flex align-items-center justify-content-center firstItem">
													</div>
													<div style="background-image:url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/46992/flexfun02.jpg');" className="col-12 col-md d-flex align-items-center justify-content-center secondItem">
													</div>

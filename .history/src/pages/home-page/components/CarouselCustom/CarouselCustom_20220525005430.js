								...
								<div className="carousel-inner">
										<div className="carousel-item active">
											<div className="row">
													...
													<div style="background-image:url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/46992/flexfun05.jpg');" className="col-12 col-md d-flex align-items-center justify-content-center" className="col-12 col-md d-flex align-items-center justify-content-center thirdItem">
														<h3>Hi.</h3>
													</div>
											</div>
										</div>

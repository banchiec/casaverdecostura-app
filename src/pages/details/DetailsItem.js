          ...
          <div className={show}>
            <div className="text-container">
              ...
              <ul className="delivery_home__list">
                <li>
                  ENTREGA GARANTIZADA AL DÍA SIGUIENTE DE LA COMPRA - 4,95 EUR.
                  <br /> Pedidos realizados de Lunes a Sábado.
                </li>
                <li>
                  ENTREGA ESTÁNDAR - 3,95 EUR / GRATUITO (PEDIDOS A PARTIR DE 30
                  EUR)
                  <br />
              ...
              <p>
                PUNTO DE ENTREGA - 3,95 EUR / GRATUITO (PEDIDOS A PARTIR DE 30
                EUR)
              </p>
              <p>En el punto de entrega que elijas en 2-3 días laborables.</p>
              <p>
              ...
              <ul>
                <li>
                  Recibirlo en una única entrega (gratis por compras superiores
                  a 30 EUR){" "}
                </li>
                <li>
              ...
              <p>
                En el momento de procesar tu compra, te mostraremos los métodos
                de envío disponibles, el coste y la fecha de entrega de tu
                pedido.
              </p>
              <b />
              <p className="regards-politics" onClick={toogleShowSidebashop}>
              ...
              <ul>
                ...
                <p>
                  ...
                  cualquier tienda de Zara del país/región donde realizaste la
                  compra.
                </p>
                <li>DESDE DOMICILIO</li>
                <p>
                  Puedes solicitar la recogida en tu domicilio accediendo a la

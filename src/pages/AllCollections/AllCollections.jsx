	...
	return (
		<>
				...
				<div className="collections-container">
					<div className="collections-content">
						...
						<div className="collections-content-text">
							...
							<p>
								Trabajamos a medida. Tú puedes elegir el vestido que más se adapte a tu
								personalidad. Desde nuestros modelos puedes elegir la forma, los tejidos,
								los colores, los complementos y modificar el modelo para sentirte más
								espectacular y segura en la boda de tu hijo o hija. Nuestro equipo te
								ayudará a elegir el modelo de tus sueños.
							</p>
							<Link to={'/summer'}>
			...
			<section className="exclusivecollection">
				<h2 className="exclusivecollection__title titlecollection">EXCLUSIVA</h2>
				<hr />
				<div className="collections-container">
					<div className="collections-content">
						<div className="collections-content-image">
